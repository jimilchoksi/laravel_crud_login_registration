...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'admission_date.required'=>'Please enter valid Admission date',
            'class.required'=>'Std/Class required',
        ]);
    ...
    public function update(Request $request, Student $student)
    {
        ...
        return redirect()->route('students.index')->with('success','Student detail updated successfully.');
    }
