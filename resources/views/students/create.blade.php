	...
	<div class="row" style="padding: 25px;">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="telephone_number" class="form-control" placeholder="Telephone">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="admission_date" class="form-control" placeholder="Admission Date" value="{{ date('Y-m-d') }}">
            </div>
        </div>
